          ...
          <div className="px-[5%] py-16 md:py-24 lg:py-28">
            <div className="relative z-10 mx-auto max-w-lg text-center">
              ...
              <p className="text-text-alternative md:text-md">
                Laima connects you to what matters. No app. No friction. Just
                WhatsApp and results that speak for themselves—98% open rates,
                same-day delivery, and the reliability of someone who knows your
                neighborhood.
              </p>
